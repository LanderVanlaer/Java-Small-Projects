...
public class LinkedList<T> implements List<T>, Cloneable {
    ...
    private LinkedListNode<T> getNode(int i) {
        checkIndex(i);
    ...
    public void add(int i, T element) {
        ...
        if(i == 0) {
            ...
            node = new LinkedListNode<>(element, getNode(i - 1), getNode(i));
        }

        size++;

        if(node != null)
            node.linkConnectedNodes();
    }
    ...
    public T remove(int i) {
        ...
        LinkedListNode<T> node = getNode(i);
        node.remove();
    ...
    private static class LinkedListNode<T> {
        ...
        public LinkedListNode(T element, LinkedListNode<T> previous) {
            this.element = element;
            this.previous = previous;
        }

        public LinkedListNode(T element, LinkedListNode<T> previous, LinkedListNode<T> next) {
            this.element = element;
            this.next = next;
            this.previous = previous;
        }

        public T changeElement(T element) {
            T t = this.element;
            this.element = element;
            return t;
        }

        public void linkConnectedNodes() {
            if(!(this.next == null))
